    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-0">
      ...
      <section className="w-full min-h-screen flex items-start bg-black text-white relative">
        <div className="hidden md:block absolute left-12 top-80 transform -translate-y-1/2">
          <h1 className="text-8xl font-extrabold leading-none roboto-condensed">EVENTS</h1>
          <h1 className="text-8xl font-extrabold leading-none roboto-condensed -mt-2">&</h1>
          <h1 className="text-8xl font-extrabold leading-none roboto-condensed -mt-2">GALLERY</h1>
        </div>

        <div className="md:hidden absolute left-4 top-38 text-left z-10">
          <h1 className="text-4xl font-extrabold roboto-condensed">EVENTS</h1>
          <h1 className="text-4xl font-extrabold roboto-condensed -mt-2">&</h1>
          <h1 className="text-4xl font-extrabold roboto-condensed -mt-2">GALLERY</h1>
        </div>
